...
--  Schema: helpdesk
--  Versione: 1.2.0 — schema sfoltito (rimosso dead code)
-- ============================================================
...
-- ============================================================
-- ENUMERATIONS
-- Usati come tipi reali sulle colonne (non solo VARCHAR).
-- NLP usa: priority_level (restituisce p1-p4).
-- Sistema usa: ticket_status, urgency_level, import_status, attachment_source.
-- ============================================================
...
CREATE TABLE tickets (
    ...
    priority_computed       priority_level,
...
-- FK circolare dopo la creazione di entrambe le tabelle
ALTER TABLE tickets
...
-- Audit trail dei cambi di stato — alimentata da TicketService
-- ============================================================
...
-- ticket_keywords — ricerca inversa (keyword → tickets)
